...
import { UpdateEfleurComponent } from './components/update-products/update-efleur/update-efleur.component';
import { UpdateEstampComponent } from './components/update-products/update-estamp/update-estamp.component';
